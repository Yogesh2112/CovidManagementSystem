...
class Quarantined:
    ...
    def search_data(self):
        ...
        cur = con.cursor()
        cur.execute(
            "select a.`SplId`,a.Name,b.RecovDate,b.Place_Id,c.PLace_name,b.hosId,d.hosName from residents a,recovered b,quarantine_center c,hospitals d where a.`SplId`=b.splid and b.Place_Id=c.Place_id and b.hosId=d.hosId and a.`"+ str(self.search_value.get())+"` like '%" + str(self.search_text.get()) + "%'")
