...
class Quarantined:
    ...
    def search_data(self):
        ...
        cur = con.cursor()
        cur.execute(
            "select a.`SplId`,a.Name,b.startDate,b.endDate,b.Place_Id,c.PLace_name from residents a,quarantined b,quarantine_center c where a.`SplId`=b.splid and b.Place_Id=c.Place_id and a.`"+ str(self.search_value.get())+"` like '%" + str(self.search_text.get()) + "%'")
